		...
		<view class="criteria">
			...
			<view class="criteria-cont">
				<view class="box-1 flex-between flex-wrap">
					<view class="box-item">
						<image :src="detail.image" mode=""></image>
						<view class="box-item-num">X{{suipianList.total}}</view>
						<view class="item-name">{{detail.suipian_name}}</view>
						<view class="item-name2">兑换需要 x{{detail.fragment_num}}</view>
					</view>
				</view>
			</view>
		</view>
