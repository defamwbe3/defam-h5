 ...
 * Share v1.0.0
 * @Class Share
 * @description engine-share 1.0.0 分享方法
 * @Author lidongtony
 * @Date 2021-04-19
...
export default {
	...
	setShareInfo(scene = {
		...
		shareInfo.title = scene.title !== '' ? scene.title : '';
		shareInfo.image = scene.image !== '' ? scene.image : '';
		...
		const path = scene.path !== '' ? scene.path : '/pages/index/index'
		shareInfo.path = path + '?shareUserId=' + shareUserId + '&id=' + scene.id
		console.log('shareInfo.path',shareInfo.path)
		// #ifdef MP
